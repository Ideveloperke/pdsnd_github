...
def get_filters():
    ...
    # TASK: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    ...
    # TASK: get user input for day of week (all, monday, tuesday, ... sunday)
    while True:
